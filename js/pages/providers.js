    ...
    providers.forEach(provider => {
      ...
      card.innerHTML = `
        ...
        <div style="display:flex;gap:8px;flex-wrap:wrap;margin-bottom:12px">
          ...
          ${provider.loginButton && (!provider.apiKeyExpires || Date.now() > provider.apiKeyExpires) ? `<button class="btn btn-secondary btn-sm" data-action="login" data-auth-provider="${provider.loginButton}">Login</button>` : ''}
